...
parameters {
  ...
  // trip level offsets
  matrix[8, Ntrips] z_trip;           //Matrix for our latent individual samples (z scores)
  vector<lower = 0>[8] sigma_trip;  //Standard deviation of learning parameters among individuals
  cholesky_factor_corr[8] Rho_trip; //Cholesky factor for covariance of learning parameters among individuals
  
  // lake level offsets
  matrix[8, Ncomp] z_comp;           //Matrix for our latent individual samples (z scores)
  vector<lower = 0>[8] sigma_comp;  //Standard deviation of learning parameters among individuals
  cholesky_factor_corr[8] Rho_comp; //Cholesky factor for covariance of learning parameters among individuals
  
  // id level offsets
  matrix[8, Nids] z_id;           //Matrix for our latent individual samples (z scores)
